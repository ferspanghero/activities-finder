...
- `project_files/` — project documentation (v1/, v2/, v3/ subdirectories + backlog)
...
- `python3 -m src --date YYYY-MM-DD [--format markdown|html|both] [--output FILE]` — deterministic pipeline
...
### HTML export
Also exports `events-YYYY-MM-DD.html` — self-contained HTML with sortable columns and clickable links. Same table structure. Generated by `src/renderers/html_renderer.py`.
